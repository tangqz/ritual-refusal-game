    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-sm border border-stone-200 p-6 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <button onClick={() => router.push('/game')} className="w-full py-2.5 text-stone-400 hover:text-stone-600 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none">{t('debrief.backToJourney', lang)}</button>
          <button onClick={onReplay} className="w-full py-2 text-stone-300 hover:text-stone-500 text-xs transition-colors focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none">{t('debrief.replay', lang)}</button>
        </div>
      </div>
    </div>
  );
